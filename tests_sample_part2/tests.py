...
class TestHW1Part2(unittest.TestCase):
	...
	def test_paginated_restaurant_search_requests(self):
		...
		self.assertTrue(len(all_restaurants_requests) == 2, msg="Incorrect number of pages")
		offsets = [0, 20]
		...
		self.assertTrue(len(all_restaurants_requests) == 6, msg="Incorrect number of pages")
		# Add more tests
